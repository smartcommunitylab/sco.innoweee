...
ssh -i sshkey -o "StrictHostKeyChecking no" $USR@$IP "sudo service innoweee-engine stop && /home/$USR/sources/deploy-innoweee-engine.sh && sed -i -E """s/^VER=[0-9.]+/VER=$RELEASE/g""" /home/dev/innoweee-engine-env && sudo service innoweee-engine start "
statusCode=$?
